...
class CommentaireRepository extends ServiceEntityRepository
{
    ...
    public function getIsLiked(User $user): bool
    {
        $entityManager = $this->getDoctrine()->getManager();
        $commentaireRepository = $entityManager->getRepository(Commentaire::class);

        $commentaire = $commentaireRepository->findOneBy([
    ...
    public function findCommentaireWithMaxMentions($sujet)
    {
        $qb = $this->createQueryBuilder('c')
            ->select('c')
            ->where('c.sujet = :sujet')
            ->setParameter('sujet', $sujet)
            ->orderBy('c.nbMentions', 'DESC')
            ->setMaxResults(1);
